...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="container">
        ...
        <h4> Edit Sedan</h4>
        <div>
            <form method="post" action="<c:url value='/sedan/update'/>">
                
            <input type="hidden" class="form-control bg-light" name="id" value="${sedan.id}">

            <div class="form-group">
              <label>Pilih Mobil</label>
              <select class="form-control bg-light" name="mobil.id">
                  <c:forEach var="mobil" items="${mobils}">
                      <option value="${mobil.id}" <c:if test="${mobil.id eq sedan.mobil.id}">selected</c:if>>
          ...
          <br>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control bg-light" name="jumlahPenumpang" value="${sedan.jumlahPenumpang}" min="1" max="9">
                </div>
                <br>

                <div class="form-group">
                    <label>Fitur Tambahan</label>
                    <input type="text" class="form-control bg-light" name="fiturTambahan" value="${sedan.fiturTambahan}" maxlength="25">
                </div>
                <br>
