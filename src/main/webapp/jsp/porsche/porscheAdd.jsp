...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="container">
        <br>    
        <h4> Tambah Porsche</h4>
        <div>
          <form method="post" action="<c:url value='/porsche/save'/>">

                <input type="hidden" class="form-control bg-light" name="id" value="${porsche.id}" required>
              ...
              <br>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control bg-light" name="kecepatanMaksimal" value="${porsche.kecepatanMaksimal}" min="1" max="999" required>
                </div>
                <br>

                <div class="form-group">
                    <label>Tipe Mesin</label>
                    <input type="text" class="form-control bg-light" name="tipeMesin" value="${porsche.tipeMesin}" maxlength="5" required>
                </div>
                <br>
